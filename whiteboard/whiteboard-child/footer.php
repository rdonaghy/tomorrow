<footer>
    <div id="bottom-links">
    	<div class="wrapper">
	        <ul>
               <li><a href="http://www.northeastern.edu/research/">Research at Northeastern</a></li>
    	        <li><a href="http://www.northeastern.edu/research/cri/">Center for Research Innovation</a></li>
        	 
            	<li><a href="http://www.northeastern.edu/insolution/">InSolution Research Blog</a></li>
	        </ul>
        </div>
    </div>
    <!-- end bottom-links -->
    <div class="wrapper"> <a alt="Northeastern University" class="logo" href="http://www.northeastern.edu"></a>
        <ul class="info">
            <li><a href="http://myneu.neu.edu/cp/home/displaylogin">MyNEU</a></li>
            <li><a href="https://prod-web.neu.edu/webapp6/employeelookup/public/main.action">Find Faculty &amp; Staff</a></li>
        ...
        &#169; <span class="the-year">2012</span> Northeastern University </p>
    </div>
</footer>
</div> <!-- end #holder -->
<script type="text/javascript">var opt = { caption: false, caption_control: false }
jQuery('a.divbox').divbox(opt);</script>
