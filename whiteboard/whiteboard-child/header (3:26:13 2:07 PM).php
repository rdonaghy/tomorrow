...
<head>
	...
	<script src="http://code.jquery.com/jquery-1.8.3.min.js"></script> <!-- later versions break divbox -->
	...
	<script src="<?php bloginfo( 'template_url' ); ?>/scripts/player-size.js" type="text/javascript"></script>
...
<div id="holder">
	<header>
		...
		<div id="tagline">
			<img src="/tomorrow/wp-content/uploads/2013/03/mth-logo.png" alt="Making Tomorrow Happen" />
		</div>
		<div id="nav-primary">
        	<nav>
