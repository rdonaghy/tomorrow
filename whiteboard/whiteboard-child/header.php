...
<head>
	<title><?php if ( is_category() ) {
		echo single_cat_title(); echo ' | '; bloginfo( 'name' ); echo ' | '; echo 'Northeastern University Research';
	} elseif ( is_tag() ) {
		...
		echo wp_title(''); echo ' | '; bloginfo( 'name' ); echo ' | '; echo 'Northeastern University Research';
	} else {
    ...
    <script src="http://www.northeastern.edu/scripts/divbox-nodrag.js" type="text/javascript"></script>
    ...
    <script type="text/javascript" src="http://www.google.com/jsapi?key=ABQIAAAA780chNBk5tiRKRznXzEY7xSxdZHYPQylHhIz0QB7o5q20wZANRT7zKV0vSe8OLWkSnyFORSqcquYig"></script>
    <script type="text/javascript" src="http://www.northeastern.edu/scripts/googleSearch.js"></script>
<script type="text/javascript">

  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-1768083-1']);
...
<div id="holder">
	<header>
		...
		<div class="nav-search">
        	...
        	<form id="searchform" role="search" onsubmit="return submitQuery()">
