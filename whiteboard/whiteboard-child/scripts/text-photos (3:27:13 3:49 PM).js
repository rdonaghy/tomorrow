$(window).load(function() {
	...
	jQuery('#button1').click(function() {
		...
		jQuery(this).find('h4').addClass('current');
		jQuery('#button2 h4').removeClass('current');
		jQuery('#button3 h4').removeClass('current');
		jQuery('#button4 h4').removeClass('current');
		jQuery('#button5 h4').removeClass('current');
	});
	...
	jQuery('#button2').click(function() {
		...
		jQuery('#text .category4').fadeOut().removeClass('show');
		jQuery('#text .category5').fadeOut().removeClass('show');
		jQuery('#button1 h4').removeClass('current');
		jQuery(this).find('h4').addClass('current');
		jQuery('#button3 h4').removeClass('current');
		jQuery('#button4 h4').removeClass('current');
		jQuery('#button5 h4').removeClass('current');
