...
<head>
    ...
    <script type="text/javascript" src="<?php bloginfo( 'template_url' ); ?>/scripts/flexiblenav.js"></script>
	<?php bloginfo( 'template_url' ); ?>/scripts/text-photos.js
	<script src="<?php bloginfo( 'template_url' ); ?>/scripts/divbox.js" type="text/javascript"></script>
	<link href="http://www.northeastern.edu/commencement/scripts/css/divbox.css" rel="stylesheet" type="text/css"/>
